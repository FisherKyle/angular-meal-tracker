...
export class CaloricRangePipe implements PipeTransform {
  transform(input: Food[], selectedCaloricRange)  {
    var output: Food[] = [];
    var selectedCaloricRange = [ "-", "0-100", "101-400", "401-800", "801-1200", ">1200" ];
    ...
    if (selectedCaloricRange != "-") {
      ...
      if (selectedCaloricRange === "0-100") {       //0-100
        for (var i = 0; i < input.length; i++) {
          if (input[i].calories > 0 && input[i].calories <= 100) { output.push(input[i]); }
          return output; }
        } else {
          return input; } }
      ...
      if (selectedCaloricRange === "101-400") {       //101-400
        for (var i = 0; i < input.length; i++) {
          if (input[i].calories > 100 && input[i].calories <= 400) { output.push(input[i]); }  return output; }
        } else {
      return input; } }
      ...
      if (selectedCaloricRange === "401-800") {       //401-800
        for (var i = 0; i < input.length; i++) {
          if (input[i].calories > 400 && input[i].calories <= 800) { output.push(input[i]); }  return output; }
        } else {
      return input; } }
      ...
      if (selectedCaloricRange === "801-1200") {
        for (var i = 0; i < input.length; i++) {
          if (input[i].calories > 800 && input[i].calories <= 1200) { output.push(input[i]); } } return output; }
        } else {
      return input; } }

      if (selectedCaloricRange === ">1200") {
        for (var i = 0; i < input.length; i++) {
          if (input[i].calories > 1200) { output.push(input[i]); } } return output; }
        } else {
      return input; } } }
